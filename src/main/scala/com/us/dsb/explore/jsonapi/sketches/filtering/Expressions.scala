package com.us.dsb.explore.jsonapi.sketches.filtering
...
object Expressions {
  ...
  import com.us.dsb.explore.jsonapi.sketches.entitymodel.AttributeInstance
  import com.us.dsb.explore.jsonapi.sketches.entitymodel.Entities.UserEntity
